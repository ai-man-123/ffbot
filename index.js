...
exec(`cd /sdcard/download && play *mp3`)
   ...
   pemuda.on('chat-update', async (mek) => {
        ...
        ownerNumber = ["6283818744065@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "6283818744065@s.whatsapp.net"
...
console.log(color(figlet.textSync(`${settings.NamaBot}`, {
	    ...
	    }), 'lightgreen')), term.slowTyping('By Ndyie - Recode by Ndyie Botz' ,{ flashStyle: term.brightWhite })
