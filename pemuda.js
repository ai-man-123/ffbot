...
try {
		...
		const katalog = (teks) => {
             res = pemuda.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© 𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★彡_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             pemuda.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = pemuda.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*_© 𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★彡_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
pemuda.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© 𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★彡_*", [{buttonId: 'simi', buttonText: {disText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
menu = `${uwu}
╭─⬣ 「 Bot Info 」 ⬣
│★彡Creator : @${dtod.split('@')[083818744065]}
│★彡Recode : @${ptod.split('@')[083818744065]}
│★彡Battery : ${baterai.battery}
│★彡Mode : ${publik ? 'Public' : 'Self'}
│★彡Total Hit : ${cmhit.length}
│★彡Prefix : ${multi ? 'Multi Prefix' : 'No Prefix'}
│★彡Nomor Owner : @${otod.split('@')[0]}
│★彡Auto Composing : ${settings.autocomposing}
└⬣Auto Recording : ${settings.autorecording}

╭─⬣ 「 User Info 」 ⬣
│★彡Status : ${isOwner ? 'Owner' : 'User'}
│★彡Nama : ${pushname}
│★彡Bio : ${stst}
│★彡Nomor : @${stod.split('@')[0]}
│★彡Info Nomor : ${num.data.countrycode} - ${num.data.carrier.type} - ${num.data.carrier.name}
└⬣
...
│
├─⬣ OWNER
│★彡${prefix}autorespon [ on/off ]
│★彡${prefix}bc [ teks/reply gif/image/video with caption ]
│★彡${prefix}tobc [ reply sticker/audio with caption ]
│★彡${prefix}return [ javascript ]
│★彡${prefix}clearall
│★彡${prefix}delchat
│★彡${prefix}mute
│★彡${prefix}unmute
│★彡${prefix}public
│★彡${prefix}self
│★彡${prefix}spam [ teks|jumlah ]
│★彡${prefix}demoteall
│★彡${prefix}promoteall
│★彡${prefix}addcmd [ teks reply stc ]
│★彡${prefix}delcmd [ reply stc ]
│★彡${prefix}listcmd
│★彡${prefix}spamsw [ teks|jumlah ]
│★彡${prefix}upswteks [ teks ]
│★彡${prefix}upswlokasi [ teks ]
│★彡${prefix}upswaudio [ reply audio ]
│★彡${prefix}upswvoice [ reply audio ]
│★彡${prefix}upswsticker [ reply sticker ]
│★彡${prefix}upswimage [ reply image with caption ]
│★彡${prefix}upswgif [ reply gif with caption ]
│★彡${prefix}upswvideo [ reply video with caption ]
│★彡${prefix}shutdown
│★彡${prefix}offline [ alasan ]
│★彡${prefix}online
│★彡${prefix}exif [ nama|author ]
│★彡${prefix}setprofile [ reply image ]
│★彡${prefix}setname [ teks ]
│★彡${prefix}setprefix [ multi/nopref ]
│★彡${prefix}setbio [ teks ]
│★彡${prefix}leave
│★彡${prefix}restart
│★彡${prefix}join [ link group ]
│★彡${prefix}addrespon [ tanya|jawab ]
│★彡${prefix}delrespon [ nama ]
│★彡${prefix}q [ reply message ]
│
├─⬣ VIRUS MENU
│★彡${prefix}virtex
│★彡${prefix}tovirgam [reply Sticker]
│★彡${prefix}bugkatalog
│★彡${prefix}bugloc
│★彡${prefix}bugrow
│★彡${prefix}buglink
│★彡${prefix}bugbutton
│★彡${prefix}bug [ jumlah ]
│★彡${prefix}bugpc2 [ jumlah ]
│★彡${prefix}bugtroli2 [ jumlah ]
│★彡${prefix}bugtroli3
│★彡${prefix}bugpc
│★彡${prefix}bugcombine
│★彡${prefix}bugtroli
...
│★彡${prefix}infogempa
│★彡${prefix}herolist
│★彡${prefix}herodetail [ hero ]
│★彡${prefix}google [ search ]
│★彡${prefix}gimage [ search ]
│★彡${prefix}wiki [ search ]
│★彡${prefix}mediafire [ link ]
│★彡${prefix}ytsearch [ judul ]
│★彡${prefix}ytmp4 [ link yt ]  PERBAIKAN
│★彡${prefix}ytmp3 [ link yt ]
│★彡${prefix} [ judul lagu ]
│★彡${prefix}video [ judul video ]
│★彡${prefix}tinyurl [ link ]
│★彡${prefix}fetch [ link ]
│★彡${prefix}igdl [ link ]
│★彡${prefix}tiktokdl [ link ]
│★彡${prefix}pinterest [ search ]
│★彡${prefix}lirik [ judul ]
│★彡${prefix}tourl [ reply image/video ]
│★彡${prefix}resepmasakan [ judul ]
│★彡${prefix}artimimpi [ teks ]
│★彡${prefix}bilangangka [ angka ]
│★彡${prefix}kalkulator [ angka ]
│★彡${prefix}fancytext [ teks ]
│★彡${prefix}githubstalk [ username ]
│★彡${prefix}translate [ kodebhs|teks ]
│★彡${prefix}ss [ link ]
│★彡${prefix}tiktokaudio [ link ]
│★彡${prefix}igstory [ link ]
│★彡${prefix}linkwa
│★彡${prefix}store [ query ]
│★彡${prefix}fb [ link ]
│★彡${prefix}twitter [ link ]
│
├─⬣ MAKER
│★彡${prefix}foliokiri 「 text 」
│★彡${prefix}foliokanan 「 text 」
│★彡${prefix}nuliskanan 「 text 」
│★彡${prefix}nuliskiri 「 text 」
│★彡${prefix}matrix [ teks ]
│★彡${prefix}googletxt [ teks ]
│★彡${prefix}spiderman [ teks ]
│★彡${prefix}express [ teks ]
│★彡${prefix}dance [ teks ]
│★彡${prefix}blackbird [ teks ]
│★彡${prefix}halloween [ teks ]
│★彡${prefix}vampire [ teks ]
│★彡${prefix}codetxt [ teks ]
│★彡${prefix}text3d [ teks ]
│★彡${prefix}warrior [ teks ]
│★彡${prefix}maker2d2 「 text 」
│★彡${prefix}maker2d3 「 text 」
│★彡${prefix}maker2d4 「 text 」
│★彡${prefix}maker3d 「 text 」
│★彡${prefix}maker3d2 「 text 」
│★彡${prefix}maker3d3 「 text 」
│★彡${prefix}maker3d4 「 text 」
│★彡${prefix}transformer 「 text 」
│★彡${prefix}googletxt 「 text 」
│★彡${prefix}battlefield 「 text 」
│★彡${prefix}coffeecup 「 text 」
│★彡${prefix}coffeecup2 「 text 」
│★彡${prefix}neon 「 text 」
│★彡${prefix}glow 「 text 」
│★彡${prefix}summer 「 text 」
│★彡${prefix}flower 「 text 」
│★彡${prefix}burn 「 text 」
│★彡${prefix}quote 「 text 」
│★彡${prefix}wooden 「 text 」
│★彡${prefix}golden 「 text 」
│
├──⬣ GROUP
│★彡${prefix}getpict [ @tag ]
│★彡${prefix}getname [ reply target ]
│★彡${prefix}getbio [ reply target ]
│★彡${prefix}promote [ @tag ]
│★彡${prefix}demote [ @tag ]
│★彡${prefix}antilink [ 1/0 ]
│★彡${prefix}nsfw [ 1/0 ]
│★彡${prefix}creategrup [ nama|@tag ]
│★彡${prefix}tictactoe [ @tag ]
│★彡${prefix}delttt
│★彡${prefix}getpp
│★彡${prefix}kick [ @tag ]
│★彡${prefix}add [ nomor ]
│★彡${prefix}getdeskgc
│★彡${prefix}sider [ reply pesan bot ]
│★彡${prefix}hacked [ teks ]
│★彡${prefix}setnamegc [ teks ]
│★彡${prefix}setdeskgc [ teks ]
│★彡${prefix}fitnah [ @tag|teks1|teks2 ]
│★彡${prefix}kontak [ @tag|nama ]
│★彡${prefix}kontag [ @tag|nama ]
│★彡${prefix}opengc
│★彡${prefix}closegc
│★彡${prefix}resetlinkgc
│★彡${prefix}linkgrup
│★彡${prefix}listonline
│★彡${prefix}listadmin
│★彡${prefix}pemudaline
│★彡${prefix}hidetag [ teks ]
│★彡${prefix}sticktag [ nama sticker ]
│★彡${prefix}totag [ reply media ]
│
├─⬣ NSFW
│★彡${prefix}trapnime
│★彡${prefix}neko
...
│★彡${prefix}poke
│★彡${prefix}slap
│★彡${prefix}komiku [ query ]
│★彡${prefix}otaku [ query ]
│★彡${prefix}chara [ query ]
│
├─⬣ TOOLS
│★彡${prefix}getscmd
│★彡${prefix}stickerwm [ nama|author ]
│★彡${prefix}takestick [ nama|author ]
│★彡${prefix}colong [ reply sticker ]
│★彡${prefix}sticker
│★彡${prefix}semoji [ emoji ]
│★彡${prefix}attp [ teks ]
│★彡${prefix}toimg
│★彡${prefix}tomp3 [ reply video ]
│★彡${prefix}tomp4 [ reply sticker gif ]
│★彡${prefix}robot [ reply audio ]
│★彡${prefix}balik [ reply audio ]
│★彡${prefix}bass [ reply audio ]
│★彡${prefix}gemuk [ reply audio ]
│★彡${prefix}detikvn [ reply audio caption angka ]
│★彡${prefix}detikvideo [ reply video caption angka ]
│★彡${prefix}tts [ kodebhs teks ]
│
├─⬣ STORAGE
│★彡${prefix}addsticker [ nama ]
│★彡${prefix}delsticker [ nama ]
│★彡${prefix}addvn [ nama ]
│★彡${prefix}delvn [ nama ]
│★彡${prefix}addimage [ nama ]
│★彡${prefix}delimage [ nama ]
│★彡${prefix}listimage
│★彡${prefix}liststicker
│★彡${prefix}listvn
│
├─⬣ JADI BOT
│★彡${prefix}stopjadibot
│★彡${prefix}jadibot
│
├─⬣ OTHER / FUN
│★彡${prefix}caripesan [ teks|jumlah ]
│★彡${prefix}slots
│★彡${prefix}suit [ gunting/batu/kertas ]
│★彡${prefix}tag [ nomor ]
│★彡${prefix}tagme
│★彡${prefix}readmore [ teks1|teks2 ]
│★彡${prefix}fitnahpc [ nomor|teks1|teks2 ]
│★彡${prefix}chat [ nomor|teks ]
│★彡${prefix}fdeface [ replyimg link|teks1|teks2 ]
│★彡${prefix}listgrup
│★彡${prefix}baileys [ reply message ]
│★彡${prefix}getcaption [ reply message ]
│★彡${prefix}pantun
│★彡${prefix}tospam [ reply audio/sticker/image|jumlah ]
│★彡${prefix}sharelock [ teks1|teks2 ]
│★彡${prefix}dadu
└─────────────────⬣
${uwu}`
...
│★彡${prefix}kick [ @tag ]
│★彡${prefix}add [ nomor ]
│★彡${prefix}kik [ Reply Pesan Target ]
│★彡${prefix}ad [ Reply Pesan Target ]
│★彡${prefix}getdeskgc
│★彡${prefix}sider [ reply pesan bot ]
│★彡${prefix}hacked [ teks ]
│★彡${prefix}setnamegc [ teks ]
